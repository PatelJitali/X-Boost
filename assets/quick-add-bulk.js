  ...
  customElements.define(
    ...
    class QuickAddBulk extends BulkAdd {
      ...
      getSectionsToRender() {
        return [
          {
            id: `quick-add-bulk-${this.dataset.id}-${this.closest('.xboost-collection-quick-add-bulk').dataset.id}`,
            section: this.closest('.xboost-collection-quick-add-bulk').dataset.id,
            selector: `#quick-add-bulk-${this.dataset.id}-${this.closest('.xboost-collection-quick-add-bulk').dataset.id}`,
          },
          {
            id: 'cart-icon-bubble',
