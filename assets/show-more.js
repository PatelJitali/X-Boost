    ...
    class ShowMoreButton extends HTMLElement {
      constructor() {
        ...
        button.addEventListener('click', (event) => {
          ...
          const nextElementToFocus = event.target.closest('.xboost-parent-display').querySelector('.show-more-item');
      ...
      expandShowMore(event) {
        const parentDisplay = event.target.closest('[id^="Show-More-"]').closest('.xboost-parent-display');
